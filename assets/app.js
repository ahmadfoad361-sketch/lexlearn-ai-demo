...
function countryScreen(){
  return hero()+'<section class="panel screen"><div class="screenhead"><div><div class="kicker">الخطوة الأولى</div><h2>اختر النظام القانوني</h2><p class="small">النسخة التجريبية الأولى مفعلة لقطر فقط. مصر ظاهرة لأن المعمار متعدد الدول، وسيُفعّل محتواها بعد المراجعة.</p></div><span class="stepbadge">طلاب القانون فقط</span></div><div class="grid2"><div class="option clickable" data-country="QA"><span class="countryflag">🇶🇦</span><b>قطر</b><small>النسخة التجريبية: جامعة قطر — LAWC 101 مدخل إلى القانون</small></div><div class="option clickable disabled" data-country="EG"><span class="countryflag">🇪🇬</span><b>مصر</b><small>قريبًا — لا يوجد محتوى منشور للطلاب بعد.</small></div></div></section>';
}
