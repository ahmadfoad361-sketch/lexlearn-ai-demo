...
function header(){
  ...
  if(a&&a.role==="admin"){
    ...
    if(s&&s.completed){
      nav='<button class="iconbtn" data-nav="today">🎯 خطة التدريب</button><button class="iconbtn" data-nav="activities">🧩 التدريب الموجّه</button><button class="iconbtn" data-nav="reviews">🔄 المراجعة</button><button class="iconbtn" data-nav="dashboard">📈 التقدم</button><button class="iconbtn" data-nav="course">📚 المقررات</button>';
    }
...
function render(){
  ...
  html+='</main><div class="footer">LexLearn AI • تعلم قانوني تكيفي • النسخة التجريبية v6.3.3</div><div id="toast" class="toast"></div>';
